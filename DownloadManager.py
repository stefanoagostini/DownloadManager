...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.progressBarH1 = QtWidgets.QProgressBar(self.history)
        self.progressBarH1.setProperty("value", 24)
        self.progressBarH1.setObjectName("progressBarH1")
        self.itemH1.addWidget(self.progressBarH1)
